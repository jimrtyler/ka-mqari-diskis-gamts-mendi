...
#GUI Variables
$FormTitleText = "დისკის გამწმენდი ჯიმ ტაილერის მიერ (PowerShellEngineer.com)"
$SelectDiskLabelText = "აირჩიე დისკი:"
$FreeSpaceLabelText = "თავისუფალი სივრცე (გიგაბაიტი): "
$TotalSpaceLabelText = "სულ სივრცე (გიგაბაიტი): "
$JunkFoundLabelText = "ნაგები ნაპოვნია (გიგაბაიტი):"
$CleanDiskBtnText = "დისკის გასუფთავება *ფაილების წაშლა*"
$SpaceCleanedLabelText = "გასუფთავებული სივრცე (გიგაბაიტი): "
$LogFileLabelText = "მოიძებნა ჟურნალის ფაილი: $abcdefg"
$CreditLabelText = "სკრიპტი ჯიმ ტაილერის მიერ - PowerShellEngineer.com"
$LogFileLocatedText = "მოიძებნა ჟურნალის ფაილი"
$AnalyzingDriveText = "დისკების ანალიზი..."
$BrowsersAreRunningText = "ბრაუზერები მუშაობს... შეატყობინეთ მომხმარებელს..."
$PleaseCloseBrowsersText = "გთხოვთ დახუროთ ყველა ვებ ბრაუზერი და სცადოთ ხელახლა."
$CleaningDriveText = "დისკის გაწმენდა..."
